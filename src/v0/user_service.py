...
class UserService:
    ...
    def post_player_recipe_update(self, recipe_table, recipe_name, recipe_active, player_id, quality, flavour_string, flavour_effects, pricing, cups, ingredients):
        ...
        try:
            # Execute the query, player_id at the end
            cur.execute(query, (recipe_name, recipe_active, quality, flavour_string, flavour_effects, pricing, cups, ingredients, player_id))
